        ...
        <div id="LandingWrapper" className="w-[100vw] h-[100vh] bg-white relative z-[10000]">
            <div id="DescriptionWrapper" className="w-[50vw] h-[100%] bg-offwhite absolute top-0 left-0 relative z-[1000]">
                <div id="DescriptionArea" className="w-[90%] absolute bottom-[30px] left-[5%] text-black">
                    <h1 className="mb-[5px] inline-block text-2xl font-semibold after:content-[''] after:block after:bg-black after:w-[30%] after:h-[5px]">{DataObject[cindex]["Gallery_Name"]}</h1>
                ...
                <div id="ChooseButton" className="group absolute bottom-0 right-[-60px] h-[50px] w-[50px] bg-offwhite rounded-t-lg overflow-hidden">
                    <a href="#gallerycontent">
                        <Image className="absolute z-10 left-[calc((50px-15px)/2)] top-[calc((50px-20px)/2)] rotate-180 transition-spacing linear group-hover:top-[calc(((50px-20px)/2)+5px)]" src="/arrow.png" alt="arrow" width={15} height={20}/>
                        <Image className="absolute left-[calc((50px-15px)/2)] top-[calc((50px-20px)/2)] rotate-180" src="/arrow_back.png" alt="arrow" width={15} height={20}/>
                    </a>
                </div>
                <div onClick={()=>{cupdate("left")}} id="LeftGalleryButton" className="group absolute top-0 right-[-60px] h-[50px] w-[50px] bg-offwhite rounded-b-lg overflow-hidden">
                    <Image className="absolute z-10 left-[calc((50px-15px)/2)] top-[calc((50px-20px)/2)] rotate-[-90deg] transition-spacing linear group-hover:left-[calc(((50px-15px)/2)-5px)]" src="/arrow.png" alt="arrow" width={15} height={20}/>
                    <Image className="absolute left-[calc((50px-15px)/2)] top-[calc((50px-20px)/2)] rotate-[-90deg]" src="/arrow_back.png" alt="arrow" width={15} height={20}/>
                </div>
